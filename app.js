...
function openTemplatesModal() {
    ...
    if (!modalEl) {
        ...
        document.getElementById('templates-close').addEventListener('click', () => modalEl.style.display = 'none');
...
function updateStimulusInspector(node) {
    ...
    html += '<div style="border-top:1px dashed #ec4899;padding-top:6px;"><label style="color:#f9a8d4;font-weight:bold;">Внутренний круг</label>';
    ...
    html += '<div style="border-top:1px dashed #ec4899;margin-top:8px;padding-top:8px;"><label style="color:#f9a8d4;font-weight:bold;">Внешнее кольцо</label>';
...
function addBlock() {
    ...
    else if (type === 'custom') { const c = prompt('Количество:', '5'); p = { count: parseInt(c) || 5, size: 120, duration: 700 }; }
